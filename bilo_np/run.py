...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--depth",'-d', type=int, default=3, help="Network depth (2 = one hidden layer)")
    ...
    parser.add_argument("--lr", type=float, default=0.01, help="Learning rate for W")
    parser.add_argument("--lr-a", type=float, default=0.01, help="Learning rate for a (finetune)")
